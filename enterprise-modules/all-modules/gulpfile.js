...
const buildEs6 = () => {
  const tsResult = tsEs6Project.src().pipe(tsEs6Project());

  return tsResult.js.pipe(gulp.dest('dist/es6'));
};

const buildEs5 = () => {
  const tsResult = tsEs5Project.src().pipe(tsEs5Project());
...
const webpackTask = (minify, styles, libraryTarget) => {
  const mainFile = styles
    ? './webpack-with-styles.js'
    : './webpack-no-styles.js';
...
gulp.task(
  ...
  series(
    'clean',
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, false, true, 'umd'),
  ),
);
gulp.task(
  'webpack-no-clean',
  series(webpackTask.bind(null, false, true, 'umd')),
);
gulp.task(
  'webpack-minify',
  series(
    ...
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, true, true, 'umd'),
  ),
);
gulp.task(
  'webpack-minify-no-clean',
  series(webpackTask.bind(null, true, true, 'umd')),
);
gulp.task(
  'webpack-noStyle',
  series(
    ...
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, false, false, 'umd'),
  ),
);
gulp.task(
  'webpack-noStyle-no-clean',
  series(webpackTask.bind(null, false, false, 'umd')),
);
gulp.task(
  'webpack-minify-noStyle',
  series(
    'clean',
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, true, false, 'umd'),
  ),
);
gulp.task(
  'webpack-minify-noStyle-no-clean',
  series(webpackTask.bind(null, true, false, 'umd')),
);
...
gulp.task(
  ...
  series(
    ...
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, false, true, 'amd'),
  ),
);
gulp.task(
  'webpack-amd-no-clean',
  series(webpackTask.bind(null, false, true, 'amd')),
);
gulp.task(
  'webpack-amd-minify',
  series(
    ...
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, true, true, 'amd'),
  ),
);
gulp.task(
  'webpack-amd-minify-no-clean',
  series(webpackTask.bind(null, true, true, 'amd')),
);
gulp.task(
  'webpack-amd-noStyle',
  series(
    ...
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, false, false, 'amd'),
  ),
);
gulp.task(
  'webpack-amd-noStyle-no-clean',
  series(webpackTask.bind(null, false, false, 'amd')),
);
gulp.task(
  'webpack-amd-minify-noStyle',
  series(
    'clean',
    'build',
    'copy-grid-core-styles',
    webpackTask.bind(null, true, false, 'amd'),
  ),
);
gulp.task(
  'webpack-amd-minify-noStyle-no-clean',
  series(webpackTask.bind(null, true, false, 'amd')),
);
