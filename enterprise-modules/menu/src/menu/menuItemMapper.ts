    ...
    switch (key) {
      ...
      case 'pinLeft':
        return {
          ...
          action: () =>
            this.columnController.setColumnPinned(
              column,
      ...
      case 'clearPinned':
        return {
          ...
          action: () =>
            this.columnController.setColumnPinned(column, null, 'contextMenu'),
      ...
      case 'autoSizeThis':
        return {
          ...
          action: () =>
            this.columnController.autoSizeColumn(
              column,
      ...
      case 'autoSizeAll':
        return {
          ...
          action: () =>
            this.columnController.autoSizeAllColumns(
              skipHeaderOnAutoSize,
              'contextMenu',
            ),
        };
      case 'rowGroup':
        return {
          name:
            ...
            ' ' +
            _.escape(
              this.columnController.getDisplayNameForColumn(column, 'header'),
            ),
          action: () =>
            this.columnController.addRowGroupColumn(column, 'contextMenu'),
          icon: _.createIconNoSpan(
            'menuAddRowGroup',
            this.gridOptionsWrapper,
            null,
      ...
      case 'rowUnGroup':
        return {
          ...
          action: () =>
            this.columnController.removeRowGroupColumn(column, 'contextMenu'),
          icon: _.createIconNoSpan(
            'menuRemoveRowGroup',
            this.gridOptionsWrapper,
            null,
      ...
      case 'resetColumns':
        return {
          ...
          action: () =>
            this.columnController.resetColumnState(false, 'contextMenu'),
        };
      case 'expandAll':
        return {
      ...
      case 'export':
        ...
        const csvModuleLoaded = ModuleRegistry.isRegistered(
          ModuleNames.CsvExportModule,
        );
        const excelModuleLoaded = ModuleRegistry.isRegistered(
  ...
  private createAggregationSubMenu(column: Column): MenuItemDef[] {
    ...
    funcNames.forEach((funcName) => {
      result.push({
        ...
        action: () => {
          this.columnController.setColumnAggFunc(
            columnToUse,
            funcName,
            'contextMenu',
          );
        ...
        checked:
          columnIsAlreadyAggValue && columnToUse!.getAggFunc() === funcName,
      });
    });
