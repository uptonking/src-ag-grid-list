...
} from './excelXmlSerializingSession';
...
type SerializingSession =
  | ExcelXmlSerializingSession
  | ExcelXlsxSerializingSession;

@Bean('excelCreator')
export class ExcelCreator
  extends BaseCreator<ExcelCell[][], SerializingSession, ExcelExportParams>
  implements IExcelCreator
{
  ...
  public createSerializingSession(
    ...
    return new (
      isXlsx ? ExcelXlsxSerializingSession : ExcelXmlSerializingSession
    )(config);
  }
