...
export class AxisTicksPanel extends Component {
  ...
  private axisTicksColorPicker: AgColorPicker;
  ...
  private initAxisTicks() {
    ...
    this.axisTicksColorPicker
      ...
      .onValueChange((newColor) =>
        this.getChartProxy().setAxisProperty('tick.color', newColor),
      );
    ...
    const initInput = (
      ...
      input
        ...
        .onValueChange((newValue) =>
          this.getChartProxy().setAxisProperty(expression, newValue),
        );
    };
