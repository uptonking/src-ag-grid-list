...
export class ChartPanel extends Component {
  ...
  private initTitles(): void {
    const titlePanelComp = this.createBean(
      new TitlePanel(this.chartController),
    );
  ...
  private initPaddingPanel(): void {
    const paddingPanelComp = this.createBean(
      new PaddingPanel(this.chartController),
    );
  ...
  private initBackgroundPanel(): void {
    const backgroundPanelComp = this.createBean(
      new BackgroundPanel(this.chartController),
    );
