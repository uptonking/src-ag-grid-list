  ...
  private initSeriesShadow() {
    this.shadowGroup
      ...
      .onEnableChange((newValue) =>
        this.chartController
          .getChartProxy()
          .setShadowProperty('enabled', newValue),
      );
    ...
    this.shadowColorPicker
      ...
      .onValueChange((newValue) =>
        this.chartController
          .getChartProxy()
          .setShadowProperty('color', newValue),
      );
    ...
    const initInput = (
      ...
      input
        ...
        .setValue(
          this.chartController.getChartProxy().getShadowProperty(property),
        )
        ...
        .onValueChange((newValue) =>
          this.chartController
            .getChartProxy()
            .setShadowProperty(property, newValue),
        );
    };
