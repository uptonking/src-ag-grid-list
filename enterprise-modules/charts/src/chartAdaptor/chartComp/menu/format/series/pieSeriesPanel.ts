...
export class PieSeriesPanel extends Component {
  ...
  private seriesTooltipsToggle: AgToggleButton;
  @RefSelector('seriesStrokeWidthSlider')
  private seriesStrokeWidthSlider: AgSlider;
  @RefSelector('seriesLineOpacitySlider')
  private seriesLineOpacitySlider: AgSlider;
  @RefSelector('seriesFillOpacitySlider')
  private seriesFillOpacitySlider: AgSlider;
  ...
  private initSeriesTooltips() {
    this.seriesTooltipsToggle
      ...
      .onValueChange((newValue) =>
        this.getChartProxy().setSeriesOption('tooltip.enabled', newValue),
      );
  }
  ...
  private initSeriesStrokeWidth() {
    this.seriesStrokeWidthSlider
      ...
      .onValueChange((newValue) =>
        this.getChartProxy().setSeriesOption('stroke.width', newValue),
      );
  }
  ...
  private initOpacity() {
    this.seriesLineOpacitySlider
      ...
      .onValueChange((newValue) =>
        this.getChartProxy().setSeriesOption('stroke.opacity', newValue),
      );
    ...
    this.seriesFillOpacitySlider
      ...
      .onValueChange((newValue) =>
        this.getChartProxy().setSeriesOption('fillOpacity', newValue),
      );
  }
  ...
  private initLabelPanel() {
    ...
    const params: FontPanelParams = {
      ...
      setEnabled: (enabled: boolean) =>
        this.getChartProxy().setSeriesOption('label.enabled', enabled),
    ...
    const calloutPanelComp = this.createBean(
      new CalloutPanel(this.chartController),
    );
  ...
  private initShadowPanel() {
    const shadowPanelComp = this.createBean(
      new ShadowPanel(this.chartController),
    );
  ...
  private getChartProxy(): PieChartProxy | DoughnutChartProxy {
    return this.chartController.getChartProxy() as
      | PieChartProxy
      | DoughnutChartProxy;
  }
