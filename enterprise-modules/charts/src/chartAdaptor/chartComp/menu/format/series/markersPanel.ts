...
export class MarkersPanel extends Component {
  ...
  private seriesMarkersGroup: AgGroupComponent;
  @RefSelector('seriesMarkerSizeSlider')
  private seriesMarkerSizeSlider: AgSlider;
  @RefSelector('seriesMarkerMinSizeSlider')
  private seriesMarkerMinSizeSlider: AgSlider;
  @RefSelector('seriesMarkerStrokeWidthSlider')
  private seriesMarkerStrokeWidthSlider: AgSlider;
  ...
  private initMarkers() {
    ...
    const shouldHideEnabledCheckbox =
      this.chartController.getChartProxy() instanceof ScatterChartProxy;
    ...
    this.seriesMarkersGroup
      ...
      .setEnabled(
        this.chartController
          .getChartProxy()
          .getSeriesOption('marker.enabled') || false,
      )
      .hideOpenCloseIcons(true)
      .onEnableChange((newValue) =>
        this.chartController
          .getChartProxy()
          .setSeriesOption('marker.enabled', newValue),
      );
    ...
    const initInput = (
      ...
      input
        ...
        .setValue(
          this.chartController.getChartProxy().getSeriesOption(expression),
        )
