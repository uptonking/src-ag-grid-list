...
export class LegendPanel extends Component {
    ...
    this.legendGroup
      ...
      .setEnabled(
        this.chartController
          .getChartProxy()
          .getChartOption<boolean>('legend.enabled') || false,
      )
      .toggleGroupExpand(false)
      .onEnableChange((enabled) => {
        this.chartController
          .getChartProxy()
          .setChartOption('legend.enabled', enabled);
  ...
  private initLegendPosition() {
    ...
    this.legendPositionSelect
      ...
      .setValue(
        this.chartController.getChartProxy().getChartOption('legend.position'),
      )
      .onValueChange((newValue) =>
        this.chartController
          .getChartProxy()
          .setChartOption('legend.position', newValue),
      );
  }
  ...
  private initLegendPadding() {
    this.legendPaddingSlider
      ...
      .setValue(
        this.chartController.getChartProxy().getChartOption('legend.spacing'),
      )
      ...
      .onValueChange((newValue) =>
        this.chartController
          .getChartProxy()
          .setChartOption('legend.spacing', newValue),
      );
  }
  ...
  private initLegendItems() {
    const initSlider = (
      ...
      input
        .setLabel(this.chartTranslator.translate(labelKey))
        .setValue(
          this.chartController
            .getChartProxy()
            .getChartOption(`legend.${expression}`),
        )
        ...
        .onValueChange((newValue) =>
          this.chartController
            .getChartProxy()
            .setChartOption(`legend.${expression}`, newValue),
        );
    };
  ...
  private initLabelPanel() {
    ...
    const initialFont = {
      ...
      style: chartProxy.getChartOption<FontStyle>(
        'legend.item.label.fontStyle',
      ),
      weight: chartProxy.getChartOption<FontWeight>(
