...
export class NavigatorPanel extends Component {
  ...
  private initNavigator() {
    ...
    this.navigatorGroup
      ...
      .setEnabled(
        this.getChartProxy().getChartOption<boolean>('navigator.enabled') ||
          false,
      )
    ...
    this.navigatorHeightSlider
      ...
      .setValue(
        String(
          this.getChartProxy().getChartOption<number>('navigator.height') ||
            '30',
        ),
      )
      .onValueChange((height) =>
        this.getChartProxy().setChartOption('navigator.height', height),
      );
  }
