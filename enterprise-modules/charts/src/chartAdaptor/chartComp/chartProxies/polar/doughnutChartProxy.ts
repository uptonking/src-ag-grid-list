...
export class DoughnutChartProxy extends PolarChartProxy {
  ...
  protected createChart(
    ...
    return ChartBuilder.createDoughnutChart(
  ...
  public update(params: UpdateChartParams): void {
    ...
    params.fields.forEach((f, index) => {
      ...
      const calloutColors =
        seriesOptions.callout && seriesOptions.callout.colors;
      const pieSeries =
        existingSeries ||
        (ChartBuilder.createSeries(seriesOptions) as PieSeries);
  ...
  protected getDefaultOptions(): PolarChartOptions<PieSeriesOptions> {
    ...
    const options =
      this.getDefaultChartOptions() as PolarChartOptions<PieSeriesOptions>;
