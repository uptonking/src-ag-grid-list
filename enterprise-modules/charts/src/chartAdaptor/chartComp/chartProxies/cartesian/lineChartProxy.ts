...
export class LineChartProxy extends CartesianChartProxy<LineSeriesOptions> {
  ...
  protected createChart(
    ...
    return ChartBuilder[
      grouping ? 'createGroupedLineChart' : 'createLineChart'
  ...
  public update(params: UpdateChartParams): void {
    ...
    const existingSeriesById = (chart.series as LineSeries[]).reduceRight(
      (map, series, i) => {
  ...
  protected getDefaultOptions(): CartesianChartOptions<LineSeriesOptions> {
    const options =
      this.getDefaultCartesianChartOptions() as CartesianChartOptions<LineSeriesOptions>;
