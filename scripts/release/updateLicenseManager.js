...
if (process.argv.length !== 3) {
  console.log(
    'Usage: node scripts/release/updateLicenseManager.js NEW_LICENSE',
  );
...
const releaseInfoIndex = licenseManagerSrc.indexOf(
...
const existingLicenseKey = licenseManagerSrc.substring(
  startOfValue,
  endOfValue,
);

const newLicenseManagerSrc = licenseManagerSrc.replace(
  existingLicenseKey,
  licenseKey,
);
