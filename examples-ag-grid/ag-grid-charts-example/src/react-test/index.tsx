...
const DateComponent = (props: any) =>
  React.createElement('time', { dateTime: props.iso8601Date }, props.message);
...
class AgChartReact extends React.Component<AgChartProps, AgChartState> {
  ...
  processPropsChanges(
    prevProps: Readonly<AgChartProps> &
      Readonly<{ children?: React.ReactNode }>,
    nextProps: Readonly<AgChartProps>,
  ) {
  ...
  shouldComponentUpdate(
    nextProps: Readonly<AgChartProps>,
    nextState: Readonly<AgChartState>,
    nextContext: any,
  ): boolean {
