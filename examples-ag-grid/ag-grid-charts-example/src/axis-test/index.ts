...
function testAutoFlippingParallelMirroredLabels() {
  ...
  title.text =
    'Parallel labels option is used. Labels should auto flip to avoid upside-down text.';
...
function testAutoFlippingPerpendicularMirroredLabels() {
  ...
  const title = new Text();
  title.text =
    'Regular labels. Labels should auto flip to avoid upside-down text.';
  title.textAlign = 'center';
  title.fontSize = 14;
  title.fontFamily = 'sans-serif';
  title.x = 450;
...
function testRotationFixedPerpendicularMirroredLabels() {
  ...
  const title = new Text();
  title.text =
    'Perpendicular labels with custom rotation that should be preserved at all times. No auto flipping.';
  title.textAlign = 'center';
  title.fontSize = 14;
  title.fontFamily = 'sans-serif';
  title.x = 450;
...
function testRotationFixedParallelMirroredLabels() {
  ...
  const title = new Text();
  title.text =
    'Parallel labels with custom rotation that should be preserved at all times. No auto flipping.';
  title.textAlign = 'center';
  title.fontSize = 14;
  title.fontFamily = 'sans-serif';
  title.x = 450;
