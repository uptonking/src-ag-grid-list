...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const coords = [
    54.479341, 8.93861, 63.990133, 35.839945, 65.664178, 40.57499, 99.20847,
    41.43623, 72.576788, 61.8498, 82.123461, 94.0185, 54.47934, 74.9984,
    26.835216, 94.0185, 36.381891, 61.8498, 9.7502099, 41.43623, 43.294501,
    40.575,
  ];
  const xx: number[] = [];
  const yy: number[] = [];
