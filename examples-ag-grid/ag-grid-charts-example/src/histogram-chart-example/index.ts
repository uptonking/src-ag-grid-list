...
import {
  HistogramSeries,
  HistogramBin,
} from 'ag-charts-community/src/chart/series/cartesian/histogramSeries';
...
const data: Palmares[] = Array(numberOfAthletes)
  .fill(0)
  .map(() => ({
    name: chance.name(),
    age: randomAge(),
...
function createHistogramChart() {
  ...
  createSlider(
    'Bin count',
    [undefined, 2, 3, 4, 5, 6, 7, 8, 9, 10, 12, 14, 16, 20, 30, 50, 100, 200],
    (number) => {
