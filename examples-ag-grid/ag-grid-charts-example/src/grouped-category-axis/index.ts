...
const categoryData: CategoryDatum[] = [
  {
    category: { labels: ['London', 'England', 'UK', 'Europe'] },
    value: 3,
    value2: 2,
  },
  {
    category: { labels: ['Bristol', 'England', 'UK', 'Europe'] },
    value: 7,
    value2: 5,
  },
  {
    category: { labels: ['Glasgow', 'Scotland', 'UK', 'Europe'] },
    value: 6,
    value2: 3,
  },
  {
    category: { labels: ['Austin', 'Texas', 'USA', 'North America'] },
    value: 4,
    value2: 7,
  },
  {
  ...
  {
    category: { labels: ['Seattle', 'Washington', 'USA', 'North America'] },
    value: 8,
    value2: 5,
  },
  {
    category: { labels: ['San Jose', 'California', 'USA', 'North America'] },
    value: 5,
    value2: 2,
  },
  {
    category: { labels: ['San Diego', 'California', 'USA', 'North America'] },
    value: 6,
    value2: 3,
  },
  {
    category: {
      labels: ['San Francisco', 'California', 'USA', 'North America'],
    },
    value: 3,
    value2: 4,
  },
...
const reducedCategoryData: CategoryDatum[] = [
  ...
  {
    category: { labels: ['San Francisco', 'California'] },
    value: 3,
    value2: 4,
  },
];
