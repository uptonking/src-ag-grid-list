  ...
  render() {
    ...
    return (
      <div style={filterStyle}>
        <span style={resetStyle} onClick={this.resetDate.bind(this)}>
          x
        </span>
        <input
        ...
        <input
          ...
          placeholder='yyyy'
          style={yyyyStyle}
          value={this.state.textBoxes.yyyy}
          maxLength='4'
        />
      </div>
    );
