...
export default class RichGridDeclarativeExample extends Component {
  ...
  static countryCellRenderer(params) {
    if (params.value) {
      return `<img border='0' width='15' height='10' style='margin-bottom: 2px' src='http://flags.fmcdn.net/data/flags/mini/${
  ...
  static dateCellRenderer(params) {
    return (
      RichGridDeclarativeExample.pad(params.value.getDate(), 2) +
      '/' +
    ...
    return (
      <div style={{ width: '100%' }}>
        ...
        <div style={{ marginTop: 10 }}>
          ...
          >
            <div style={{ float: 'left' }}>
              <button onClick={this.onRefreshData} className='btn btn-primary'>
                Refresh Data
              </button>
            </div>
            <div style={{ float: 'right' }}>
              Filter API:
              <button
                onClick={this.invokeSkillsFilterMethod}
                className='btn btn-primary'
              >
                Invoke Skills Filter Method
              </button>
              <button onClick={this.dobFilter} className='btn btn-primary'>
                DOB equals to 01/01/2000
              </button>
            </div>
          </div>
          <div
            ...
            >
              ...
              >
                ...
                <AgGridColumn
                  ...
                  filterParams={{
                    cellRenderer:
                      RichGridDeclarativeExample.countryCellRenderer,
                    cellHeight: 20,
                  }}
                  enableRowGroup
                  enablePivot
