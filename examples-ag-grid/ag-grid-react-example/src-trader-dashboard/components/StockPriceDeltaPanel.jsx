...
export default class extends Component {
  ...
  updatePriceDelta(pricingDelta) {
    ...
    let deltaPercentage =
      (pricingDelta.currentPrice - pricingDelta.previousPrice) /
      pricingDelta.currentPrice;
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (
      !isEqual(this.props.pricingDelta, nextProps.pricingDelta) ||
  ...
  render() {
    ...
    let swingStyle =
      this.state.delta >= 0 ? positiveSwingStyle : negativeSwingStyle;
