...
export default class extends Component {
  constructor(props) {
    ...
    this.renderingWidth =
      this.props.graphWidth - this.margin.left - this.margin.right;
    this.renderingheight =
      this.props.graphHeight - this.margin.top - this.margin.bottom;

    this.x = d3.scaleTime().range([0, this.renderingWidth]);

    this.y = d3.scaleLinear().rangeRound([this.renderingheight, 0]);
  ...
  render() {
    ...
    if (!this.props.historicalData) {
      ...
      return <div style={containerStyle} ref='historyGraph'></div>;
    }
  }
}
