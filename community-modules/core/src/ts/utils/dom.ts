...
export function containsClass(
  ...
  if (element.className) {
    ...
    const endsWithClass =
      element.className.lastIndexOf(' ' + className) ===
      element.className.length - className.length - 1;
...
export function iterateNamedNodeMap(
  map: NamedNodeMap,
