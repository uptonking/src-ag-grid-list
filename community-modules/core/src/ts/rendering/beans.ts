...
export class Beans {
  ...
  public headerNavigationService: HeaderNavigationService;
  ...
  public userComponentFactory: UserComponentFactory;
  ...
  public maxDivHeightScaler: MaxDivHeightScaler;
  @Autowired('frameworkOverrides')
  public frameworkOverrides: IFrameworkOverrides;
  @Autowired('detailRowCompCache')
  public detailRowCompCache: DetailRowCompCache;
  @Autowired('cellPositionUtils') public cellPositionUtils: CellPositionUtils;
  @Autowired('rowPositionUtils') public rowPositionUtils: RowPositionUtils;
  @Autowired('selectionController')
  public selectionController: SelectionController;
  @Optional('selectionHandleFactory')
  public selectionHandleFactory: ISelectionHandleFactory;
