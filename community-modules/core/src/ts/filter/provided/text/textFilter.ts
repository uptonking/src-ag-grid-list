...
export class TextFilter extends SimpleFilter<TextFilterModel> {
  ...
  protected areSimpleModelsEqual(
    aSimple: TextFilterModel,
    bSimple: TextFilterModel,
  ): boolean {
  ...
  public individualConditionPasses(
    ...
    if (cellValue == null) {
      return (
        filterOption === SimpleFilter.NOT_EQUAL ||
        filterOption === SimpleFilter.NOT_CONTAINS
      );
    }
