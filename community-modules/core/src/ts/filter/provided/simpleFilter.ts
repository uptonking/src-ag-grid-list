...
> extends ProvidedFilter {
  ...
  protected abstract individualConditionPasses(
  ...
  protected abstract isConditionUiComplete(
  ...
  protected abstract areSimpleModelsEqual(
    a: ISimpleFilterModel,
    b: ISimpleFilterModel,
  ): boolean;
  ...
  protected abstract setConditionIntoUi(
  ...
  public getModelFromUi(): M | ICombinedSimpleModel<M> {
    ...
    if (
      ...
      this.isConditionUiComplete(ConditionPosition.Two)
    ) {
      return {
  ...
  protected areModelsEqual(
    a: M | ICombinedSimpleModel<M>,
    b: M | ICombinedSimpleModel<M>,
  ): boolean {
    // both are missing
    if (!a && !b) {
      return true;
    ...
    const oneSimpleOneCombined =
      (!aIsSimple && bIsSimple) || (aIsSimple && !bIsSimple);
  ...
  protected setModelIntoUi(
    model: ISimpleFilterModel | ICombinedSimpleModel<M>,
  ): Promise<void> {
    ...
    forEach(filterOptions, (option) => {
      ...
      if (typeof option === 'string') {
        ...
        text = customOption
          ...
          : this.translate(value as keyof ISimpleFilterTranslations);
      }
  ...
  protected updateUiVisibility(): void {
    const firstConditionComplete = this.isConditionUiComplete(
      ConditionPosition.One,
    );
