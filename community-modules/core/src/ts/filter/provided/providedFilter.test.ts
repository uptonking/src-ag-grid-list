...
class TestFilter extends ProvidedFilter {
  ...
  constructor(
    ...
    rowModelType: string = Constants.ROW_MODEL_TYPE_CLIENT_SIDE,
  ) {
    super();
    ...
    gridOptionsWrapper.getLocaleTextFunc.mockReturnValue(
