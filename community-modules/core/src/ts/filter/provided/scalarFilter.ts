...
> extends SimpleFilter<M> {
  ...
  protected individualConditionPasses(
    ...
    const compareResult = this.nullComparator(
      filterType,
      filterValue,
      cellValue,
    );
    ...
    switch (filterType) {
      ...
      case ScalarFilter.IN_RANGE: {
        const compareToResult = this.nullComparator(
          filterType,
          filterValueTo,
          cellValue,
        );
