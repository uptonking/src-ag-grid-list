...
export class Events {
  ...
  public static EVENT_CHART_RANGE_SELECTION_CHANGED =
  ...
  public static EVENT_DISPLAYED_COLUMNS_WIDTH_CHANGED =
  ...
  // all the row models.
  public static EVENT_COLUMN_ROW_GROUP_CHANGE_REQUEST =
  ...
  public static EVENT_COLUMN_AGG_FUNC_CHANGE_REQUEST =
