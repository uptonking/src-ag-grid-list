...
import {
  IHeaderComp,
  IHeaderParams,
} from '../../headerRendering/header/headerComp';
import {
  IHeaderGroupComp,
  IHeaderGroupParams,
} from '../../headerRendering/headerGroup/headerGroupComp';
import {
  ICellRendererComp,
  ICellRendererParams,
...
} from '../../rendering/overlays/noRowsOverlayComponent';
...
export class UserComponentFactory extends BeanStub {
  ...
  public newHeaderGroupComponent(
    params: IHeaderGroupParams,
  ): Promise<IHeaderGroupComp> {
    return this.createAndInitUserComponent(
  ...
  public newFullWidthGroupRowInnerCellRenderer(
  ...
  public newCellRenderer(
    ...
    return this.createAndInitUserComponent(
      target,
      params,
      isPinned ? PinnedRowCellRendererComponent : CellRendererComponent,
      null,
      true,
    );
  }

  public newCellEditor(
    colDef: ColDef,
  ...
  public newLoadingOverlayComponent(
    params: ILoadingOverlayParams,
  ): Promise<ILoadingOverlayComp> {
    return this.createAndInitUserComponent(
      this.gridOptions,
      params,
      LoadingOverlayComponent,
  ...
  public newNoRowsOverlayComponent(
    params: INoRowsOverlayParams,
  ): Promise<INoRowsOverlayComp> {
    return this.createAndInitUserComponent(
      this.gridOptions,
      params,
      NoRowsOverlayComponent,
  ...
  public newFilterComponent(
    ...
    modifyParamsCallback: ModifyParamsCallback<IFilterParams>,
  ): Promise<IFilterComp> {
    return this.createAndInitUserComponent(
      colDef,
      params,
  ...
  public newSetFilterCellRenderer(
    target: ISetFilterParams,
    params: ISetFilterCellRendererParams,
  ): Promise<ICellRendererComp> {
    return this.createAndInitUserComponent(
      target,
      params,
  ...
  public newToolPanelComponent(
    toolPanelDef: ToolPanelDef,
    params: IToolPanelParams,
  ): Promise<IToolPanelComp> {
    return this.createAndInitUserComponent(
      toolPanelDef,
      params,
      ToolPanelComponent,
  ...
  public newStatusPanelComponent(
    def: StatusPanelDef,
    params: IStatusPanelParams,
  ): Promise<IStatusPanelComp> {
  ...
  private createAndInitUserComponent<A extends IComponent<TParams>, TParams>(
    ...
    const paramsAfterCallback = modifyParamsCallback
      ? modifyParamsCallback(params, componentInstance)
      : params;

    const deferredInit = this.initComponent(
      componentInstance,
      paramsAfterCallback,
    );
  ...
  private addReactHacks(params: any): void {
    ...
    const frameworkComponentWrapper = this.context.getBean(
  ...
  public lookupComponentClassDef<A extends IComponent<TParams> & B, B, TParams>(
    ...
    if (definitionObject != null) {
      const componentPropertyValue: AgComponentPropertyInput<
        IComponent<TParams>,
        TParams
      > = (definitionObject as any)[propertyName];
      ...
      if (componentPropertyValue != null && !usingDefaultComponent) {
        if (typeof componentPropertyValue === 'string') {
          ...
          this.agComponentUtils.doesImplementIComponent(componentPropertyValue)
        ) {
      ...
      componentSelectorFunc = (definitionObject as any)[
    ...
    if (
      ...
      (hardcodedNameComponent ||
        HardcodedJsComponent ||
        hardcodedJsFunction ||
        HardcodedFwComponent)
    ) {
      throw Error(
    ...
    if (hardcodedJsFunction) {
      ...
      return this.agComponentUtils.adaptFunction(
        ...
        hardcodedJsFunction,
        false,
        ComponentSource.HARDCODED,
      ) as ComponentClassDef<A, B, TParams>;
    }

    const selectorResult = componentSelectorFunc
      ? componentSelectorFunc(params)
      : null;
    ...
    const registeredCompClassDef = this.lookupFromRegisteredComponents(
      propertyName,
      componentNameToUse,
    ) as ComponentClassDef<A, B, TParams>;
  ...
  >(
    ...
    if (
      this.agComponentUtils.doesImplementIComponent(
        registeredComponent.component as AgGridRegisteredComponentInput<A>,
      )
    ) {
      return {
        ...
        componentFromFramework: false,
        source:
          registeredComponent.source == RegisteredComponentSource.REGISTERED
            ? ComponentSource.REGISTERED_BY_NAME
  ...
  public createFinalParams<TParams>(
    ...
    const userParams: TParams = definitionObject
      ? (definitionObject as any)[propertyName + 'Params']
      : null;
  ...
  >(
    ...
    if (missing) {
      ...
      const overrideName = holder
        ? (holder as any)[propertyName]
        : defaultComponentName;
      const nameToReport = overrideName ? overrideName : defaultComponentName;
      if (!optional) {
        console.error(
          `Could not find component ${nameToReport}, did you forget to configure this component?`,
        );
      }
      return null;
    }
  ...
  private initComponent<A extends IComponent<TParams>, TParams>(
    component: A,
    params: TParams,
  ): Promise<void> | void {
