...
export class AgDialog extends AgPanel {
  private RESIZE_TEMPLATE /* html */ = `<div class="ag-resizer-wrapper">
  ...
  public setMaximizable(maximizable: boolean) {
    ...
    const maximizeButtonComp = (this.maximizeButtonComp = new Component(
    ...
    eGui.appendChild(
      (this.maximizeIcon = _.createIconNoSpan(
        'maximize',
    ...
    eGui.appendChild(
      (this.minimizeIcon = _.createIconNoSpan(
        'minimize',
        this.gridOptionsWrapper,
      )),
    );
    ...
    maximizeButtonComp.addManagedListener(
      eGui,
      'click',
