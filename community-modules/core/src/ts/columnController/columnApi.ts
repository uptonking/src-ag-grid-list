...
export class ColumnApi {
  ...
  public getColumnGroup(name: string, instanceId?: number): ColumnGroup {
    return this.columnController.getColumnGroup(name, instanceId);
  }
  public getOriginalColumnGroup(name: string): OriginalColumnGroup {
  ...
  public getDisplayNameForColumn(
    ...
    return (
      this.columnController.getDisplayNameForColumn(column, location) || ''
    );
  }
  ...
  public setColumnPinned(key: string | Column, pinned: string): void {
    this.columnController.setColumnPinned(key, pinned, 'api');
  }
  public setColumnsPinned(keys: (string | Column)[], pinned: string): void {
  ...
  public moveColumns(columnsToMoveKeys: (string | Column)[], toIndex: number) {
  ...
  public getSecondaryPivotColumn(
    ...
    return this.columnController.getSecondaryPivotColumn(
      pivotKeys,
      valueColKey,
    );
  }
  ...
  public removeValueColumns(colKeys: (string | Column)[]): void {
  ...
  public addValueColumns(colKeys: (string | Column)[]): void {
  ...
  public removeRowGroupColumn(colKey: string | Column): void {
    this.columnController.removeRowGroupColumn(colKey, 'api');
  }
  public removeRowGroupColumns(colKeys: (string | Column)[]): void {
    this.columnController.removeRowGroupColumns(colKeys, 'api');
  }
  public addRowGroupColumn(colKey: string | Column): void {
    this.columnController.addRowGroupColumn(colKey, 'api');
  }
  public addRowGroupColumns(colKeys: (string | Column)[]): void {
  ...
  public removePivotColumn(colKey: string | Column): void {
    this.columnController.removePivotColumn(colKey, 'api');
  }
  public removePivotColumns(colKeys: (string | Column)[]): void {
    this.columnController.removePivotColumns(colKeys, 'api');
  }
  public addPivotColumn(colKey: string | Column): void {
    this.columnController.addPivotColumn(colKey, 'api');
  }
  public addPivotColumns(colKeys: (string | Column)[]): void {
  ...
  public autoSizeColumn(key: string | Column, skipHeader?: boolean): void {
  ...
  public getPrimaryColumns(): Column[] {
    return this.columnController.getAllPrimaryColumns();
  }

  // below goes through deprecated items, prints message to user, then calls the new version of the same method

  public columnGroupOpened(
    group: OriginalColumnGroup | string,
    newValue: boolean,
  ): void {
    console.error(
