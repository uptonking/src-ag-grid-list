...
export class CssClassApplier {
  public static addHeaderClassesFromColDef(
  ...
  public static addToolPanelClassesFromColDef(
    abstractColDef: AbstractColDef,
    eHeaderCell: HTMLElement,
    gridOptionsWrapper: GridOptionsWrapper,
    column: Column | null,
    columnGroup: OriginalColumnGroup | null,
  ) {
    if (_.missing(abstractColDef)) {
      return;
    }
  ...
  public static addColumnClassesFromCollDef(
    ...
    if (typeof classesOrFunc === 'function') {
      ...
      const headerClassFunc = classesOrFunc as (
        params: any,
      ) => string | string[];
