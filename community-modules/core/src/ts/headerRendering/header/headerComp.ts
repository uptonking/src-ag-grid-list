...
export class HeaderComp extends Component implements IHeaderComp {
  ...
  private setupTap(): void {
    ...
    if (this.params.enableMenu) {
      ...
      const showMenuFn = (event: TapEvent | LongTapEvent) => {
        options
          .getApi()
          .showColumnMenuAfterMouseClick(this.params.column, event.touchStart);
      };
  ...
  private setupMenu(): void {
    ...
    const hideShowMenu =
      !this.params.enableMenu || (_.isIOSUserAgent() && !suppressMenuHide);
