...
(function (ChangeDetectionStrategyType) {
  ...
  (ChangeDetectionStrategyType =
    exports.ChangeDetectionStrategyType ||
    (exports.ChangeDetectionStrategyType = {})),
);
var ChangeDetectionService = /** @class */ (function () {
  function ChangeDetectionService() {
    ...
    this.strategyMap =
      ...
      ] = new DeepValueStrategy()),
      (_a[
        ChangeDetectionStrategyType.IdentityCheck
      ] = new SimpleFunctionalStrategy(function (a, b) {
        return a === b;
      })),
      (_a[ChangeDetectionStrategyType.NoCheck] = new SimpleFunctionalStrategy(
        function (a, b) {
          return true;
        },
      )),
  ...
  ChangeDetectionService.prototype.getStrategy = function (
  ...
  DeepValueStrategy.areEquivalent = function (a, b) {
    ...
    try {
      ...
      if (newB) {
        ...
        b.areEquivPropertyTracking.some(function (other) {
          return other === a;
        })
      ) {
        return true;
