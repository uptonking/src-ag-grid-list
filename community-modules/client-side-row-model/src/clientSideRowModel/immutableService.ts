...
export class ImmutableService extends BeanStub implements IImmutableService {
  ...
  public createTransactionForRowData(
    data: any[],
  ): [RowDataTransaction, { [id: string]: number }] | undefined {
    ...
    const existingNodesMap: {
      [id: string]: RowNode | undefined;
    } = this.clientSideRowModel.getCopyOfNodesMap();

    const suppressSortOrder =
