...
test('utcParse', () => {
...

  {
    ...
    expect(
      parse0('Tuesday, 03 September, 2019 - 14:50:17.300')!.getTime(),
    ).toBe(utcTimestamp);
    expect(
      parse1('Tuesday, 03 September, 2019 - 14:50:17.300')!.getTime(),
    ).toBe(utcTimestamp);
    expect(
      parse2('Tuesday,  3 September, 2019 - 14:50:17.300')!.getTime(),
    ).toBe(utcTimestamp);
    expect(parse3('Tuesday, 3 September, 2019 - 14:50:17.300')!.getTime()).toBe(
      utcTimestamp,
    );
  }

  {
    ...
    expect(parse0('Вторник, 03 Сентября, 2019 - 14:50:17.300')!.getTime()).toBe(
      utcTimestamp,
    );
    expect(parse1('Вторник, 03 Сентября, 2019 - 14:50:17.300')!.getTime()).toBe(
      utcTimestamp,
    );
    expect(parse2('Вторник,  3 Сентября, 2019 - 14:50:17.300')!.getTime()).toBe(
      utcTimestamp,
    );
    expect(parse3('Вторник, 3 Сентября, 2019 - 14:50:17.300')!.getTime()).toBe(
      utcTimestamp,
    );
